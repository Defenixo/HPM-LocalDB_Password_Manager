...
public class EncryptionObj {
	...
	private static void HashFunc(String keystr) throws NoSuchAlgorithmException {
	...
	protected static String DecryptFuncHOUSAINIPASS(String toDenc, String theKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
		//HashFunc(hashKey(toDenc));
		Cipher itemCipher;
		try {
			itemCipher = Cipher.getInstance("AES");
